...
**Note:** We archived this repo. For more information about deploying Java apps with Heroku, see [Deploying JAR and WAR Files](https://devcenter.heroku.com/articles/deploying-jar-and-war-files).
