...
function _downloadWebappRunner(version, callback) {
  let url = `https://repo1.maven.org/maven2/com/heroku/webapp-runner/${version}/webapp-runner-${version}.jar`
  if (knownWebappRunnerLegacyVersions.includes(version)) {
    url = `https://repo1.maven.org/maven2/com/github/jsimone/webapp-runner/${version}/webapp-runner-${version}.jar`
  }
